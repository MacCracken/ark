# Ark — Claude Code Instructions

## Project Identity

**Ark** (English: the vessel) — Unified package manager CLI for AGNOS
...
All AGNOS users (installs packages). Ark is the primary interface for package installation, removal, and management across the system.
...
- Do not bypass SHA verification on package installs
- Do not reimplement dependency resolution — that belongs in nous
